...
export default function WelcomePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 rounded-sm">
      ...
      {/* Sign In Card */}
      <div className="bg-white shadow-md p-8 w-[555px] h-[228px] mb-6">
        ...
        <div className="flex justify-center items-center mt-12">
          <Link href="/sign-in">
            <button className="w-[457px] h-[46px] bg-[#52965E] text-white py-2 rounded-sm">
              Sign in
            </button>
          </Link>
        </div>
      ...
      {/* Register Card */}
      <div className="bg-white shadow-md w-[555px] h-[228px] p-8">
        ...
        <div className="flex justify-center items-center mt-12">
          <Link href="/register/step1">
            <button className="w-[457px] h-[46px] bg-black text-white py-2 rounded-sm">
              Register
            </button>
          </Link>
        </div>
